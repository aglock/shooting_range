...
const char HTTP_SHOOT_FORM[] PROGMEM      = "<form action=\"choice\"><input type=\"submit\" id=\"showTarget\" name=\"showTarget\" value=\"Visa m&aring;l\"><br/><input type=\"submit\" id=\"hideTarget\" name=\"hideTarget\" value=\"D&ouml;lj m&aring;l\"><br/><input type=\"submit\" id=\"Snabb skytte\" name=\"snabbskytte\" value=\"snabbskytte\"><br/><input type=\"submit\" id=\"Konfigurera\" name=\"config\" value=\"config\"></form>";
