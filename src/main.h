...
const char HTTP_FASTSHOOTING_BODY[] PROGMEM = "<h1>Pistol shooting practice</h1><p>Snabbskytte, m&aring;l visning {{showTime}} msek, g&ouml;mt i {{hideTime}} msek.</p>";
