...
const char HTTP_SERVO_CONFIG_FORM[] PROGMEM = "<form action=\"/config\">Start position: <label for\"startpos\" id=\"label_start\">{{startpos}}</label><br/><input type=\"range\" onInput=\"setStartPos()\" id=\"startpos\" name=\"startpos\" value=\"{{startpos}}\" min=\"1\" max=\"180\"/><br/>Stop position: <label for\"endpos\" id=\"label_end\">{{endpos}}</label><br/><input type=\"range\" onInput=\"setEndPos()\" id=\"endpos\" name=\"endpos\" value=\"{{endpos}}\" min=\"1\" max=\"180\"/><br/><p>Snabbskytte konfiguration<p/>Visa (s): <input type=\"number\" name=\"showTime\" value=\"{{showTime}}\"><br/>G&ouml;m (s): <input type=\"number\" name=\"hideTime\" value=\"{{hideTime}}\"><br/><br/><input type=\"submit\" id=\"save_btn\" name=\"save_btn\" value=\"Spara\"/><input type=\"submit\" id=\"return_btn\" name=\"return_btn\" value=\"&Aring;terg&aring;\"></form><br/><form action=\"/config\"><input type=\"submit\" name=\"reset\" value=\"&Aring;terst&auml;ll till standard\"></form>";
#endif
